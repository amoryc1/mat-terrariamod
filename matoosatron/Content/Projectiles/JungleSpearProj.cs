...
namespace matoosatron.Content.Projectiles
{
	public class JungleSpearProj : ModProjectile
	{
		...
		public override bool PreAI() {
			...
			Lighting.AddLight(Projectile.position, 0f, 0.25f, 0f);
